...
/// три пикселя, а обводка в 2 точки мерцает. Набор говорит о том же прямо —
/// «в списке чатов `animate: false`».
...
/// собеседника. Кольцо же помещается в квадрат: его радиус относится к радиусу
/// фотографии как 64 к 58, это 0.95 от стороны.
